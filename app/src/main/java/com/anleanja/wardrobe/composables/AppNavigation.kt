...
import com.anleanja.wardrobe.view_models.CalendarNavigationEvent
import com.anleanja.wardrobe.view_models.CalendarViewModel
import com.anleanja.wardrobe.view_models.ItemDetailViewModel
import com.anleanja.wardrobe.view_models.OutfitDetailViewModel
        ...
        topBar = {
            ...
            when {
                ...
                route == Screen.About.route -> {
                    // About screen provides its own top bar.
                }
...
sealed class Screen(val route: String, val icon: ImageVector, @StringRes val labelResId: Int) {
    ...
    data object About : Screen("about", Icons.Outlined.Lightbulb, R.string.action_about)
